...
class PostCreateFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (editingPost != null) {
            binding.btnUpdatePicEditProfileFragment.visibility = View.GONE
            binding.profilePicEditProfileFragment.isClickable = false
        } else {
        ...
        binding.saveBtn.setOnClickListener {
            ...
            if (user != null) {
                val selectedImageUri = feedViewModel.selectedImageUri.value
                if (selectedImageUri != null) {
                    showCustomMessage(
                        title = "Publishing Post",
                        body = "We are launching your post to the galaxy, please wait a moment...",
                        duration = 4000
                    )
                }
                if (editingPost != null) {
            ...
            if (isSaved) {
                if (editingPost == null) {
                    showCustomMessage(
                        ...
                        body = "Your journey has been shared with the community.",
                        duration = 3000
                    )
                } else {
                    showCustomMessage(
                        title = "Post Updated!",
                        body = "Your space adventure has been updated.",
                        duration = 3000
                    )
                }
