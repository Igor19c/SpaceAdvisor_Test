...
import com.example.spaceadvisor.ui.adapters.DestinationsSavedAdapter
import com.example.spaceadvisor.databinding.FragmentDestinationSavedBinding
...
class DestinationsSavedFragment : BaseFragment() {

    private var _binding: FragmentDestinationSavedBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDestinationSavedBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setupRecyclerView() {
        adapter = DestinationsSavedAdapter(
            ...
            object : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
                ...
                override fun onChildDraw(
                    ...
                    if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
                        val holder = viewHolder as DestinationsSavedAdapter.ViewHolder
    ...
    private fun observeViewModel() {
        destinationViewModel.savedDestinations.observe(viewLifecycleOwner) { destinations ->
            ...
            binding.destCountSavedFragment.text = "${destinations.size.toString()} saved"
